...
function insertarImagen_url(url_imagen) {
  ...
  var htmlFragment =
    "<div class='list-group-item list-group-item-action list-group-item-primary'><div class='card-body'>" +
    "<img src='images/" +
    url_imagen +
    "' class='card-img' alt='Oferta'>";
...
function insertarContenidoImagen_url(nombre_producto, descripcion, precio) {
  ...
  var htmlFragment =
    ...
    descripcion +
    " </small></h5>" +
    "<p class='card-row precio'><small class='text-body-secondary'>" +
    precio +
    "</small></p>" +
    "</div>" +
    "</div>";
...
function mostrarMenuSalsas(url_imagen) {
  var htmlFragment =
    "<div class='list-group-item list-group-item-action list-group-item-primary redes' target='_blank'><div class='card-body frasecentral '>" +
    "<img src='images/" +
    url_imagen +
    "' class='card-img' alt='Oferta' style='width:200px; height:auto;'>" +
    "</div>" +
    "</div>";
...
function ventanaRedesSociales() {
  ...
  htmlFragment +=
    ...
    sharedURL +
    "' onclick='copyTextToClipboard(sharedURL)' class='list-group-item list-group-item-action list-group-item-primary redes' target='_blank'><div class='card-body'>" +
  ...
  //URL TIKTOK
  htmlFragment +=
    "<a href='https://www.tiktok.com/upload/?reference=" +
    sharedURL +
    "' onclick='copyTextToClipboard(sharedURL)' class='list-group-item list-group-item-action list-group-item-primary redes' target='_blank'><div class='card-body'>" +
  ...
  //URL INSTAGRAM
  htmlFragment +=
    "<a href='https://www.instagram.com/share?url=" +
    sharedURL +
    "' onclick='copyTextToClipboard(sharedURL)' class='list-group-item list-group-item-action list-group-item-primary redes' target='_blank'><div class='card-body'>" +
...
function ventanaContactanosRedesSociales() {
  ...
  htmlFragment +=
    "<a href='https://www.facebook.com/profile.php?id=100076363658883' class='list-group-item list-group-item-action list-group-item-primary redes' target='_blank'><div class='card-body'>" +
    "<img src='images/redes/fb.png' class='card-img' alt='Facebook'>" +
    "<h5 class='card-title'> Facebook</h5>" +
    "</div>" +
    "</a>";
  ...
  //URL WHATS
  htmlFragment +=
    "<a href='https://api.whatsapp.com/send?phone=+526568230426&text=Buen%20d%C3%ADa,%20Me%20gustar%C3%ADa%20pedir%20informaci%C3%B3n.' class='list-group-item list-group-item-action list-group-item-primary redes' target='_blank'><div class='card-body'>" +
    "<img src='images/redes/wsp.png' class='card-img' alt='Whatssap'>" +
    "<h5 class='card-title'> Whatssap</h5>" +
    "</div>" +
    "</a>";
  ...
  //URL TIKTOK
  htmlFragment +=
    "<a href='https://www.tiktok.com/@kokowings' class='list-group-item list-group-item-action list-group-item-primary redes' target='_blank'><div class='card-body'>" +
    "<img src='images/redes/tk.png' class='card-img' alt='Tiktok'>" +
    "<h5 class='card-title'> Tiktok </h5>" +
    "</div>" +
    "</a>";
...
function mostrarApartadoHamburguesaSeleccion() {
  const apartado =
    "<div class='list-group-item list-group-item-action list-group-item-primary card-body-hamburguesa'>" +
...
function mostrarTodasLasOfertas() {
  ...
  retornarOfertas +=
    insertarImagen_url("hamburguesas/sirlonSencilla.png") +
  ...
  retornarOfertas +=
    insertarImagen_url("hotdog/hotdog_logo.png") +
    insertarContenidoImagen_url(
      "Combo 4",
      "2 Dogos + papas chicas + soda de sabor",
      " $110"
    );
...
function mostrarTodosLosBoneles() {
  ...
  retornarBoneles +=
    ...
    insertarContenidoImagen_url(
      "Chico (310 gr)",
      "Zanahorias con aderezo Ranch + Apio",
      "$110"
    );
  ...
  retornarBoneles +=
    ...
    insertarContenidoImagen_url(
      "Grande (910 gr)",
      "Zanahorias con aderezo Ranch + Apio y papas fritas chicas ¡GRATIS!",
      " $325"
    );
...
function mostrarTodasLasAlitas() {
  ...
  retornarAlitas +=
    ...
    insertarContenidoImagen_url(
      "Alitas (12 pz)",
      "Zanahorias con aderezo Ranch + Apio + 2 salsas ",
      "$120"
    );
  ...
  retornarAlitas +=
    ...
    insertarContenidoImagen_url(
      "Alitas (20 pz) ",
      "Zanahorias con aderezo Ranch + Apio + 3 salsas",
      "$200"
    );
  ...
  retornarAlitas +=
    ...
    insertarContenidoImagen_url(
      "Alitas (40 pz)",
      "Zanahorias con aderezo Ranch + Apio + 4 salsas",
      "$400"
    );
...
function mostrarTodasLasHamburguesas() {
  ...
  retornarhamburguesas +=
    insertarImagen_url("hamburguesas/sirlonSencilla.png") +
    insertarContenidoImagen_url(
      "Sirlon",
      "Mayonesa + Ketchup + Mostaza + Lechuga + Cebolla + Tomate + Queso",
      "$62"
    );

  retornarhamburguesas +=
    insertarImagen_url("hamburguesas/sirlondoble.png") +
    insertarContenidoImagen_url(
      "Sirlon Doble",
      "3 Liquidos + Lechuga + Cebolla + Tomate +  2 Quesos + 2 Carnes",
      " $73"
    );

  retornarhamburguesas +=
    insertarImagen_url("hamburguesas/baconCheese.png") +
    insertarContenidoImagen_url(
      "Bacon Cheese",
      "Mayonesa + Queso Derretido + Jalapeño + Queso",
      " $80"
    );

  retornarhamburguesas +=
    insertarImagen_url("hamburguesas/sirlonBBQMango.png") +
    insertarContenidoImagen_url(
      "Sirlon BBQ/Mango Habanero",
      "Mayonesa + BBQ + Mango Habanero + Doble Tocino + Jamon + 2 Quesos",
      " $80"
    );

  retornarhamburguesas +=
    insertarImagen_url("hamburguesas/hamburgesadepollo.png") +
    insertarContenidoImagen_url(
      "Hamburguesa de Pollo",
      "Mayonesa + Ketchup + Lechuga + Tomate + Pollo",
      " $80"
    );

  retornarhamburguesas +=
    insertarImagen_url("hamburguesas/especial.png") +
    insertarContenidoImagen_url(
      "Especial",
      "3 Liquidos + Lechuga + Cebolla + Tomate +  Doble Tocino + Winnie Americano + Jamon + Queso + Aguacate",
      " $90"
    );

  retornarhamburguesas +=
    insertarImagen_url("hamburguesas/sirlontriple.png") +
    insertarContenidoImagen_url(
      "Sirlon Triple",
      "3 Liquidos + Lechuga + Cebolla + Tomate +  3 Quesos + 3 Carnes",
      " $85"
    );

  retornarhamburguesas +=
    insertarImagen_url("hamburguesas/kokoburger.png") +
    insertarContenidoImagen_url(
      "KOKO Burger",
      "3 Liquidos + Lechuga + Cebolla + Tomate + Queso Derretido + Salsicha para Asar + Doble Tocino + Queso + Carne + Aguacate",
      " $98"
    );

  retornarhamburguesas +=
    insertarImagen_url("hamburguesas/sirlonconpollo.png") +
    insertarContenidoImagen_url(
      "Sirlon con Pollo",
      "Mayonesa + Ketchup + Lechuga + Tomate + Pollo + Queso + Carne",
      " $98"
    );
...
function mostrarTodasLasHamburguesasLibra() {
  ...
  retornarhamburguesasLibra +=
    ...
    insertarContenidoImagen_url(
      "Sirlon con Pollo",
      "Mayonesa + Ketchup + Lechuga + Tomate + Pollo + Queso",
      "$105"
    );
...
function mostrarTodasLasPapasFritas() {
  ...
  retornarPapasFritas +=
    insertarImagen_url("papasfritas/papas_logo.png") +
    insertarContenidoImagen_url("Papas Chicas (150 gr)", "", "$35");

  retornarPapasFritas +=
    insertarImagen_url("papasfritas/papas_logo.png") +
    insertarContenidoImagen_url("Papas Medianas (300 gr)", "", "$59");

  retornarPapasFritas +=
    insertarImagen_url("papasfritas/papas_logo.png") +
    insertarContenidoImagen_url("Papas Grandes (450 gr)", "", "$85");

  retornarPapasFritas +=
    insertarImagen_url("papasfritas/papas_logo.png") +
    insertarContenidoImagen_url("Papas Familiares (600 gr)", "", "$115");
...
function mostrarTodasLosHotDogs() {
  var retornarHotDogs = "";
  retornarHotDogs +=
    insertarImagen_url("hotdog/hotdogsencillo.png") +
    insertarContenidoImagen_url(
      "Hot dog sencillo",
      "Mostaza + Ketchup + Mayonesa + Tomate + Curtidos",
      "$30"
    );
  ...
  retornarHotDogs +=
    ...
    insertarContenidoImagen_url(
      "Dogo Cheese",
      "Mostaza + Ketchup + Mayonesa + (Rufles, queso para nachos y tocino)",
      "$40"
    );

  retornarHotDogs +=
    insertarImagen_url("hotdog/banderilla.png") +
    insertarContenidoImagen_url(
      "Banderillas",
      "mostaza + Ketchup + Mayonesa ",
      "$35"
    );

  retornarHotDogs +=
    insertarImagen_url("hotdog/dedosQueso.png") +
...
function mostrarTodasLasBebidas() {
  var retornarBebidas = "";
  retornarBebidas +=
    insertarImagen_url("bebidas/kool-aid.png") +
    insertarContenidoImagen_url("Kool Aid", "", "$15");

  retornarBebidas +=
    insertarImagen_url("bebidas/shasta.png") +
    insertarContenidoImagen_url("Shasta", "", " $20");

  retornarBebidas +=
    insertarImagen_url("bebidas/coca-cola.png") +
    insertarContenidoImagen_url("Coca-Cola", "", " $25");

  retornarBebidas +=
    insertarImagen_url("bebidas/agua-ciel.png") +
...
function mostrarExtras() {
  var retornarExtras = "";
  retornarExtras +=
    insertarImagen_url("extras/ranch.png") +
    insertarContenidoImagen_url("Ranch", "", "$15");

  retornarExtras +=
    insertarImagen_url("extras/queso.png") +
    insertarContenidoImagen_url("Queso", "", "$15");

  retornarExtras +=
    insertarImagen_url("extras/winnie.png") +
    insertarContenidoImagen_url("Winnie", "", "$10");

  retornarExtras +=
    insertarImagen_url("extras/tocino.png") +
    insertarContenidoImagen_url("Tocino", "", "$15");

  retornarExtras +=
    insertarImagen_url("extras/salchicha.png") +
    insertarContenidoImagen_url("Salchicha", "", "$15");

  retornarExtras +=
    insertarImagen_url("extras/bonelesnaturales.png") +
    insertarContenidoImagen_url("Boneless", "", "$35");

  retornarExtras +=
    insertarImagen_url("extras/salsas.png") +
  ...
  if (termino != "") {
    ...
    comidas.forEach(function (comida, index) {
      ...
      if (nombreComidaElement && precioComidaElement) {
        ...
        if (
          nombreComida.includes(termino.toLowerCase()) ||
          precioComida.includes(termino.toLowerCase())
        ) {
          var comidaContainer = document.createElement("div");
          comidaContainer.classList.add(
            "comida-container",
            "list-group-item",
